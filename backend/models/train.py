...
Reads data/matches.csv, builds features (15 total incl. ELO, pitch_type),
trains XGBoost + LightGBM + Pipeline(StandardScaler + LogisticRegression),
...
def train_and_evaluate(csv_path: str | Path | None = None) -> dict[str, float]:
    ...
    X, y = fb.build_dataset(min_index=50)
